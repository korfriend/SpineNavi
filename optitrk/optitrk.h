...
namespace optitrk
{
	...
	__dojostatic bool GetRigidBodyLocationByIdx(const int rb_idx, float* mat_ls2ws, std::bitset<128>* cid = NULL, float* rb_mse = NULL, std::vector<float>* rbmk_xyz_list = NULL, std::vector<bool>* mk_tracked_list = NULL, std::string* rb_name = NULL);
	__dojostatic bool GetRigidBodyLocationByName(const std::string& name, float* mat_ls2ws, int* rb_idx = NULL, std::bitset<128>* cid = NULL, float* rb_mse = NULL, std::vector<float>* rbmk_xyz_list = NULL, std::vector<bool>* mk_tracked_list = NULL);
